...
# from ApiManager.form import RegisterForm
# from django.contrib.auth.hashers import make_password
# from ApiManager.models import EmailVerifyRecord
# from ApiManager.utils.email_send import send_register_email
